...
| 2:40–3:00 | Show repo allow-list env var + README safety section; end card | "Three layers of gating, one config file. RepoMedic: give your repos a doctor you can overrule. Built in a week on TrueForge." |
